---
title: "Threat Modeling Express: a fast start"
lang: 'en'
canonicalSlug: 'threat-modeling-intro'
description: "How to engage the team, map critical assets, and ship controls quickly with Threat Modeling Express."
...
<Callout variant="danger" title="Mini game" icon="🔥">
	Play the <a href="https://guisso.dev/tme-game/" target="_blank">Threat Modeling Express mini game</a> to practice what you read.
</Callout>
...
![Threat Modeling Express data flow](./threat-modeling-sample.svg)
...
![Critical assets map](./threat-modeling-assets.svg)

<span class="pill pill-orange">A1</span> **User Session Token**:
...
<span class="pill pill-orange">A2</span> **Personal Data**:
...
<span class="pill pill-orange">A3</span> **Database Credentials**:
...
![Threat actors linked to impacts](./threat-modeling-threats.svg)

<span class="pill pill-red">T1</span> **Sensitive Data Interception**:
...
<span class="pill pill-red">T2</span> **Session Token Exposure**:
...
<span class="pill pill-red">T3</span> **Service Unavailability**:
...
<span class="pill pill-red">T4</span> **Credentials Exposure**:
...
<span class="pill pill-red">T5</span> **Unauthorized Access to Personal Information**:
...
![Controls prioritized with evidence](./threat-modeling-controls.svg)
...
<span class="pill pill-blue">C2</span> **Encryption of Sensitive Data in Transit**:
...
<span class="pill pill-blue">C3</span> **Secure Token Storage**:
...
<span class="pill pill-blue">C4</span> **Rate Limiting and Request Control**:
...
<span class="pill pill-blue">C5</span> **Encrypted Credential Storage in Secret Management Systems**:
...
<span class="pill pill-blue">C6</span> **Granular Access Controls**:
...
- Threat Management
  ...
  - <span class="pill pill-blue">Internal</span> **Threat Modeling API**: AppSec team internal system at Globo.
  - <span class="pill pill-blue">In Progress</span> **[ThreatMax](https://github.com/fguisso/threatmax)**  
